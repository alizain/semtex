defmodule Semtex do
  ...
  def unwrap_nodes([{_tag, _attrs, _children} | _] = nodes, [tag_to_find | remaining_tags]) do
    next_nodes =
  ...
  def find_node([{_tag, _attrs, _children} | _] = nodes, tag_to_find) do
    nodes
    |> Enum.find(nil, fn
